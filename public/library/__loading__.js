...
pc.script.createLoadingScreen(function (app) {
  var showSplash = function () {
    ...
    logo.src = 'https://storage.googleapis.com/djzs-bucket/NegotationAcademy/Textures/dj_zs_library_instructions_loading.png';
    ...
    if(typeof window.parent.SocketManager !=="undefined"){
      window.parent.SocketManager.subscribe_GetSocket((socket) => {
        socketInstance = socket;
         ...
         socketInstance.emit('updateUserLocation', "library");
        }
      });
    }
       setTimeout(()=>{
          if(typeof window.parent.libraryLoadedClickOnKro !=="undefined")
          window.parent.libraryLoadedClickOnKro();
        },1000);
  ...
  var hideSplash = function () {
    if (window.localStorage.getItem("libraryFirst") == "true") {
      window.localStorage.setItem("libraryFirst", "false");
