var PlayerModelHandler = pc.createScript('playerModelHandler');
PlayerModelHandler.attributes.add('male', {type: 'entity'});
PlayerModelHandler.attributes.add('female', {type: 'entity'});
PlayerModelHandler.attributes.add('beard', {type: 'entity'});
PlayerModelHandler.attributes.add('glassesM', {type: 'entity'});
PlayerModelHandler.attributes.add('glassesF', {type: 'entity'});
PlayerModelHandler.attributes.add("mhair",{type:'entity',array:true});
PlayerModelHandler.attributes.add("mtop",{type:'entity',array:true});
PlayerModelHandler.attributes.add("fhair",{type:'entity',array:true});
PlayerModelHandler.attributes.add("ftop",{type:'entity',array:true});
PlayerModelHandler.attributes.add("frameTextures",{type:'asset',array:true});

PlayerModelHandler.attributes.add("frameColour",{type:'rgba',array:true});
PlayerModelHandler.attributes.add("skinColour",{type:'rgba',array:true});
PlayerModelHandler.attributes.add("lipColour",{type:'rgba',array:true});
PlayerModelHandler.attributes.add("hairColour",{type:'rgba',array:true});
PlayerModelHandler.attributes.add("topAColour",{type:'rgba',array:true});
PlayerModelHandler.attributes.add("topBColour",{type:'rgba',array:true});
PlayerModelHandler.attributes.add("topCColour",{type:'rgba',array:true});
PlayerModelHandler.attributes.add("topCBColour",{type:'rgba',array:true});
PlayerModelHandler.attributes.add("mTopUColour",{type:'rgba',array:true});
PlayerModelHandler.attributes.add("fTopUColour",{type:'rgba',array:true});
PlayerModelHandler.attributes.add("bottomColour",{type:'rgba',array:true});
// initialize code called once per entity
PlayerModelHandler.prototype.initialize = function() {
    
};

PlayerModelHandler.prototype.applyAvatarDetails = function(avatarDetails) {
    console.log(avatarDetails);
    if(avatarDetails.genderData===0){
        this.male.enabled=true;
        if(this.mhair[avatarDetails.mhairData]&&avatarDetails.mhairData!=3)
        ...
        // this.male.model.meshInstances[8].material.update();
         ...
         if(avatarDetails.beard==1){
            ...
            // this.beard.model.meshInstances[0].material.diffuse=this.hairColour[avatarDetails.mhairColorData];
            // this.beard.model.meshInstances[0].material.update();
         }
        ...
        if(avatarDetails.mtopData==0){
            ...
            console.log(avatarDetails.mtop2ColorData);
            console.log(this.mTopUColour[avatarDetails.mtop2ColorData]);
            if(this.mTopUColour[avatarDetails.mtop2ColorData]){
        ...
        if(this.fhair[avatarDetails.fhairData])
            this.fhair[avatarDetails.fhairData].enabled=true;
        if(this.ftop[avatarDetails.ftopData])
        ...
        meshZ19.material=materialZ19;
         ...
         // this.female.model.meshInstances[7].material.diffuse=this.bottomColour[avatarDetails.fbottomColorData];
...
PlayerModelHandler.prototype.update = function(dt) {
    
};

// swap method called for script hot-reloading
// inherit your script state here
// PlayerModelHandler.prototype.swap = function(old) { };
